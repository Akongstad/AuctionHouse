...
var file_Auction_auction_proto_rawDesc = []byte{
	...
	0x32, 0xcc, 0x07, 0x0a, 0x0c, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x6f, 0x75, 0x73,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x10, 0x53,
	0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x64, 0x12,
	0x0d, 0x2e, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x1a, 0x0d,
	0x2e, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x00, 0x42,
	0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6b,
	0x6f, 0x6e, 0x67, 0x73, 0x74, 0x61, 0x64, 0x2f, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x48,
	0x6f, 0x75, 0x73, 0x65, 0x2f, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_Auction_auction_proto_depIdxs = []int32{
	...
	8,  // 21: Auction.AuctionHouse.SetStateReleased:input_type -> Auction.Void
	1,  // 22: Auction.AuctionHouse.OpenConnection:output_type -> Auction.Message
	8,  // 23: Auction.AuctionHouse.CloseConnection:output_type -> Auction.Void
	3,  // 24: Auction.AuctionHouse.Bid:output_type -> Auction.BidReply
	2,  // 25: Auction.AuctionHouse.Result:output_type -> Auction.ResultMessage
	8,  // 26: Auction.AuctionHouse.Broadcast:output_type -> Auction.Void
	3,  // 27: Auction.AuctionHouse.Replicate:output_type -> Auction.BidReply
	12, // 28: Auction.AuctionHouse.getID:output_type -> Auction.PortIndex
	8,  // 29: Auction.AuctionHouse.RegisterPulse:output_type -> Auction.Void
	8,  // 30: Auction.AuctionHouse.RingElection:output_type -> Auction.Void
	9,  // 31: Auction.AuctionHouse.SelectNewLeader:output_type -> Auction.ElectionPorts
	8,  // 32: Auction.AuctionHouse.BroadcastNewLeader:output_type -> Auction.Void
	8,  // 33: Auction.AuctionHouse.CutOfReplicate:output_type -> Auction.Void
	6,  // 34: Auction.AuctionHouse.PromptTimeAndDuration:output_type -> Auction.TimeMessage
	14, // 35: Auction.AuctionHouse.AccessCritical:output_type -> Auction.ReplyMessage
	8,  // 36: Auction.AuctionHouse.ReceiveRequest:output_type -> Auction.Void
	8,  // 37: Auction.AuctionHouse.ReceiveReply:output_type -> Auction.Void
	8,  // 38: Auction.AuctionHouse.SetStateReleased:output_type -> Auction.Void
